...
from .views import render, login, verify_token, render_csv, render_pdf, upload_excel, RenderMaterialRequisition, PORequisitionHandling, job_status
...
urlpatterns = [
    ...
    path('job-status/<str:job_id>/', job_status),
    path('login/', login),
